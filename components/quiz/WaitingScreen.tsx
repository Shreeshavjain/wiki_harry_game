...
export default function WaitingScreen({ state }: WaitingScreenProps) {
  return (
    <div className="glass-panel-premium max-w-lg w-full p-10 text-center animate-fade-in flex flex-col items-center justify-center min-h-[360px] relative overflow-hidden">
      ...
      <h2 className="font-[family-name:var(--font-cinzel)] text-2xl sm:text-3xl tracking-[0.2em] text-gold-bright m-0 mb-4 drop-shadow-[0_0_10px_rgba(201,162,39,0.3)]">
        {state === "WAITING" ? "AWAITING QUESTIONS" : "GET READY"}
      </h2>
      
      <p className="text-parchment-dim m-0 text-sm sm:text-base opacity-80 max-w-[280px] leading-relaxed tracking-wider">
        {state === "WAITING" 
